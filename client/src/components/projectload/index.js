...
const ProjectLoad = ({ descRef, detRef, descVisible, detVisible, textAnim, projectId, imgIdx, subIndex, addIndex, direction }) => {
    ...
    const projectData = [{title: '3D Modeling', date: '2017-Present', desc: 'Miscellaneous 3D works and works in progress', type: '3D Modeling', tools: 'Maya, Blender, Substance Painter, Illustrator', contribution: ''},
    ...
    const currentProject = projectData.filter(project => {return project.title === projectId.replace(/-/g, ' ')});
