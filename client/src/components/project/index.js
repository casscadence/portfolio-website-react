...
const Project = ({setLoaderName, link}) => {
  ...
  const projectDataObjects = [{id: 1, category: 'models', title: 'Modeling', client: 'personal', role: 'N/A', date: '2017 +', desc: 'Miscellaneous modeling works & works in progress', type: '3D Modeling', tools: 'Maya, Blender, Substance Painter, Illustrator', contribution: 'N/A'},
  {id: 2, category: 'graphics, animation, programming', title: 'Agent Silhouette', client: 'PSI Games', role: 'Lead Artist/Programmer', date: '2016', desc: 'Deep underground in a faraway jungle, hides an expansive complex dedicated to the heinous plans of an evil mad scientist. Your mission, should you choose to accept it, is to infiltrate the facility, using your graceful agility and expert stealth tactics to navigate the area and avoid its hostile inhabitants. Reach your objective without being seen, thwart the villain’s master plan, and save the world!', type: 'Single Player, third person, side-scrolling, stealth platformer', tools: 'Unity, Visual Studio, Photoshop, Illustrator', contribution: 'environment, animation, UI, programming, logo, marketing'},
  {id: 3, category: 'models, animation, programming', title: 'Harbor', client: 'e2i Creative', role: 'Lead Artist/Programmer', date: '2018', desc: "Works from the PTSD Project: Harbor during the internship. The project involved continuing from the previous team's progress on a VR experience which assists medical professionals in caring for PTSD patients with a soothing atmosphere and in assessing PTSD with objects that created interest. The images above showcase the changes made from the beginning of the project to our team's completion of the project.", type: 'Exploration', tools: 'Unity, Visual Studio, Maya, Blender, Substance Painter, Photoshop', contribution: "modeling, unwrapping, texturing, programming, sound, FX, animation"},
  {id: 4, category: 'models, animation, programming', title: 'Cooking', client: 'e2i Creative', role: 'Artist', date: '2018', desc: "Works from the Cooking Project during the internship. The project involved an app which used foods and cooking items as obstacles and power-ups in a temple run style game of the endless runner genre, in order to aid Parkinson's patients with diet and nutrition to ease symptoms and teach others about Parkinson's and caring for health.", type: 'Single Player, third person, endless runner', tools: 'Maya, Blender, Substance Painter, Photoshop', contribution: 'modeling, unwrapping, texturing'},
  {id: 5, category: 'models, graphics, animation, programming', title: 'Toys N Tyrants', client: 'Aardvark Games', role: 'Artist', date: '2018', desc: 'In Toys N Tyrants, players adventure through a dungeon of toys-gone-bad to defeat the Mad King, ending his tyranny once and for all! However, perhaps the true journey was the friends you made along the way.', type: 'Single Player & Co-Op, third person, Hack-and-Slash', tools: 'Unity, Visual Studio, Maya, Substance Painter', contribution: 'modeling, unwrapping, texturing, animation, UI, marketing'},
  {id: 6, category: 'models, programming', title: 'Boom Bots', date: '2017', desc: 'Boom Bots is a fast-paced arena shooter where the only type of weapon is a grenade customizable by the player. Choose how your grenades travel, how they detonate, and what type of explosion they cause with an added variety of movement styles at your disposal.', type: 'Single player, first person, 3D-shooter', tools: 'Unity, Visual Studio, Maya, Photoshop, Illustrator', contribution: 'Created all environment models, created props (catwalk, wires, pipes, metal beam lights, door sensors), created emission maps, created textures (all environment & props), upgraded texture quality for all game textures, created logo, created and designed itch.io page'},
  {id: 7, category: 'graphics', title: 'Cornucoopia', date: '2015', desc: 'A quick, competitive rogue-like board game where hungry, (un)lucky foxes try to steal not-so-defenseless chickens.', type: 'Multiplayer, physical board game', tools: 'Photoshop, Illustrator, 3D Printer', contribution: "Created all cards & characters, and contributed to game's mechanics"}];
      ...
      <div className='container project-page'>
        <div className='text-container'>
          ...
          <div className='project-desc'>
              ...
              <div className='subtitle'><img src={require(`../../assets/logos/e2i.png`)} alt='' /><h3>{data[0].client}</h3></div>
              <h1>{data[0].title}</h1>
              </div>
